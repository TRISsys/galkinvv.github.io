...
Получена с симпотомом "постоянно артефактит". При тесте с выключенной интегрированной работает 3d на основном GPU, Opencl - на обоих. SLI пока что не тестировался.
