...
Имеет скол и в отличие отсоседних не нулевое, а бесконченое сопротивление.
...
#### Fermi (420 - 625, 6??), GF???
##### Zotac GTX560 (чёрный)
Работает, но сильно греется даже при хорошем теплоотводе. Вероятно надо скальпировать. Скальпировано, собрано без крышки; теперь температура не превышает 75 (при запуске без корпуса).
...
Редко были замечены трудноразличимые артефакты в виде точек. Долго работала и продолжает работать. Из тестов артефакты можно увидеть только в LightMark

### AMD/ATI
#### Radeon HD 6xxx Series
##### XFX HD6770 1GDDR5(чёрная)
Карта стартует нестабильно, обычно вырубается (исчезает напряжение на gpu и памяти) почти сразу после старта. Если она при этом основная - то система двльше не работает. При осмотре осциллографом ножки chip enable flash-микросхемы было зафиксировано длительное состояние налчия напряжения на gpu.
