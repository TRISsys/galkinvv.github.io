...
Имеет прогар в одной из фаз питания GPU. Однако сопротивление GPU по линии питания ~1.1Ом. Однако по питанию памяти и 3.3v с платы - сопортивление нулевое. Поиск места кз не производился. Также вероятно сбит C79.
