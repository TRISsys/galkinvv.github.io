...
##### Asus GTS250 1GB GDDR3 (cиний)
карта от студента миэта. который снял с нее множество элементов, втч шим, твердотельные конденсаторы, транзисторы. все поставлено назад, отсутствует шим памяти, включение без него привело к предположительному выходу из строя двух транзисторов рядом.на нее есть донор.
